...
export function summaryText(
  ...
  // Samtidig metabol rubbning avslöjad av Na–Cl-gapet (primär metod, steg 4).
  if (f.HAGMA && r.naClGap !== undefined && r.naClGap > 3)
    s += ' Na–Cl-gapet är förhöjt, vilket talar för en samtidig metabol alkalos.';
  if (f.HAGMA && r.naClGap !== undefined && r.naClGap < -3)
    s += ' Na–Cl-gapet är sänkt, vilket talar för en samtidig metabol acidos med normalt anjongap.';
