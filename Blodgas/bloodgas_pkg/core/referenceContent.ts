...
Minskad produktion ses vid leversvikt och ökad elimination vid nefrotiskt syndrom. Kan även vara relaterat till svår undernäring.
<br><br>
Litium är en positivt laddad katjon (precis som paraproteiner vid myelom) och sänker anjongapet på samma sätt när det förekommer i höga koncentrationer i blodet, vid både akut överdos och kronisk litiumbehandling med ackumulering, exempelvis vid nedsatt njurfunktion eller dehydrering.
<br><br> <b>Symtom:</b> <br> Vid hypoalbuminemi ses central och perifer ödem. Vid litiumintoxikation ses i stället tremor, illamående, konfusion, ataxi och i svåra fall kramper och medvetandepåverkan.
<br><br> <b>Utredning:</b> <br> Vid misstanke om hypoalbuminemi: leverenzymer, kreatinin, urinsticka och s-albumin. Vid misstanke om litiumintoxikation: s-litiumkoncentration, kreatinin (njurfunktionen styr eliminationen) och EKG.
<br><br> <b>Behandling:</b> <br>
Vid hypoalbuminemi: fastställ orsaken och säkerställ adekvat proteinintag. Substitution med iv-albumin är sällan hållbart på lång sikt.
<br><br>
Vid litiumintoxikation: sätt ut litium och ge vätska. Njurfunktionen avgör eliminationen, och vid uttalad eller stigande litiumnivå, njurpåverkan eller neurologiska symtom kan hemodialys krävas. Kontakta Giftinformationscentralen vid osäkerhet.`,
