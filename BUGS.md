...
| B-006 | Neuro's peripheral nerves were faint in the legs and contained overlapping legacy/current arm geometry | 2026-07-25 @ `a516dfa` | 2026-07-25 @ `bbb213f` | Regenerated the embedded nerve asset without 26 overlapping legacy arm surfaces, retained the calibrated upper-limb/hand and all lower-limb sources, and changed the material to opaque dark ochre. |
| B-008 | Kropps-atlas showed an open skull roof with the brain protruding above the skeletal model | 2026-07-25 @ `bbb213f` | 2026-07-25 @ `bbb213f` | The four anatomical objects existed, but cropped skull-base source variants had been embedded. Regenerated those objects from the complete BodyParts3D frontal, bilateral parietal, and occipital sources. |
| B-010 | Neuro's regenerated arm nerves still had asymmetric source sets: 60 right arm blocks versus 48 left, including repeated right-hand branches | 2026-07-25 @ `fa2f6aa` | 2026-07-25 @ `fa2f6aa` | Rebuilt the arms from 48 canonical right sources and generated an exact mirrored left set. Generation now requires all 16 brachial-plexus/shoulder/chest branches, reverses mirrored face winding, and validates reflected bounds. |
